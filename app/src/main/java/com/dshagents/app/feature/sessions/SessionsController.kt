...
import com.dshagents.app.api.RemoteInlineAttachmentRef
import com.dshagents.app.api.RemoteProject
import com.dshagents.app.api.SessionsApi
import com.dshagents.app.api.RemoteDevice
import com.dshagents.app.api.RemoteSession
import com.dshagents.app.api.RemoteSessionCreateAndStartRequest
import com.dshagents.app.api.RemoteDashboardSnapshot
import com.dshagents.app.api.RemoteSessionPage
import com.dshagents.app.api.RemoteSessionsMutationResponse
import com.dshagents.app.api.isValidRuntimeInstanceId
import com.dshagents.app.api.isValidRuntimeType
import com.dshagents.app.feature.auth.AuthSessionReader
import com.dshagents.app.feature.devices.DeviceRuntimeList
import com.dshagents.app.feature.devices.toAgentDevice
import com.dshagents.app.feature.devices.toDeviceRuntimeList
...
class SessionsController(
    ...
    private fun toState(
        ...
        activePage: com.dshagents.app.api.RemoteSessionPageInfo,
        archivedPage: com.dshagents.app.api.RemoteSessionPageInfo,
    ): SessionsState {
    ...
    private fun RemoteSessionPage.pageInfo() = com.dshagents.app.api.RemoteSessionPageInfo(
        hasMore = hasMore,
