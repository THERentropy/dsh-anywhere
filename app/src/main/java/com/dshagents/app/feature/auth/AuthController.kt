package com.dshagents.app.feature.auth

import com.dshagents.app.api.ApiException
import com.dshagents.app.api.AuthApi
import com.dshagents.app.api.AuthMeResponse
import com.dshagents.app.api.AuthResponse
import com.dshagents.app.api.MobileLoginStatusResponse
...
class AuthController(
    ...
    suspend fun accountAuthConfig(): Result<com.dshagents.app.api.AuthConfigResponse> =
    ...
    suspend fun sendEmailCode(email: String): Result<com.dshagents.app.api.EmailCodeResponse> =
    ...
    suspend fun createWebLoginSession(serverUrl: String): Result<WebLoginSession> {
        ...
        return withContext(Dispatchers.IO) {
            runCatching {
                ...
                com.dshagents.app.feature.auth.createWebLoginSession(server)
            }.recoverCatching { error ->
    ...
    ): WebLoginCallback = com.dshagents.app.feature.auth.parseWebLoginCallback(callbackUrl, session)
...
internal fun completeWebLoginSession(
    token: com.dshagents.app.api.OAuthTokenResponse,
