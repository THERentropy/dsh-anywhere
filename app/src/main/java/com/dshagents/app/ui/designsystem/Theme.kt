package com.dshagents.app.ui.designsystem
...
private val LightDshAgentsColors = DshAgentsColors(
    isDark = false,
...
private val DarkDshAgentsColors = DshAgentsColors(
    isDark = true,
...
val LocalAAColors = staticCompositionLocalOf { LightDshAgentsColors }
...
private val LightDshAgentsColorScheme = lightColorScheme(
    primary = AAColor.Ink,
...
private val DarkDshAgentsColorScheme = darkColorScheme(
    primary = DarkDshAgentsColors.ink,
    onPrimary = DarkDshAgentsColors.canvas,
    background = DarkDshAgentsColors.canvas,
    onBackground = DarkDshAgentsColors.ink,
    surface = DarkDshAgentsColors.canvas,
    onSurface = DarkDshAgentsColors.ink,
    surfaceVariant = DarkDshAgentsColors.subtle,
    outline = DarkDshAgentsColors.border,
)

private val DshAgentsTypography = Typography(
...
fun DshAgentsTheme(
    ...
    val colors = if (darkTheme) DarkDshAgentsColors else LightDshAgentsColors
    val colorScheme = if (darkTheme) DarkDshAgentsColorScheme else LightDshAgentsColorScheme
    ...
    CompositionLocalProvider(LocalAAColors provides colors) {
        MaterialTheme(
            ...
            typography = DshAgentsTypography,
            content = content,
        )
    }
}
